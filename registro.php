        ...
        <section class="sec--regis">
            ...
            <form action="" method="POST" class="form--regis">
                ...
                <button class="boton" type="submit">
                    <p class="p--boton"> Registrarse</p>
                </button>
            </form>
            <p class="p--usuario"> Ya tenes usuario? </p>
            <button onclick="location.href='login.php'" class="b--login" type="submit">
                <p class="p--registrarse">Ingresa</p>
            </button>
